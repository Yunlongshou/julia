...
@testset "Indexing" begin
    ...
    @testset "multidimensional" begin
        ...
        for (k1, k2, T) in channeled_tasks(1, gen_getindex_data)[1][1]
        ...
        for (k1, k2, k3, k4, T) in channeled_tasks(1, gen_getindex_data4)[1][1]
        ...
        for (b2, k1, k2) in channeled_tasks(1, gen_setindex_data)[1][1]
        ...
        for (b2, k1, k2, k3, k4) in channeled_tasks(1, gen_setindex_data4)[1][1]
